...
function runBaseTests() {
  px_tooltip_1 = document.getElementById('px_tooltip_1');

  suite('Base Automation Tests for px-tooltip', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-tooltip fixture is created', function() {
      assert.isTrue(document.getElementById('px_tooltip_1') !== null);
    });

...
---
Permit approvals from Development Services Department legacy permitting system that includes permits processed through paper submission or the hybrid system. Permit types began migrating to the current cloud-based system in 2018. Data from the current system can be found in [this dataset](/datasets/development-permits-set2/).
